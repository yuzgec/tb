        ...
        <div class="owl-carousel owl-simple" data-toggle="owl"
            ...
            <div class="banner banner-cat">
                ...
                <div class="banner-content banner-content-static text-center">
                    <h3 class="banner-title">Kategori Adı</h3>
            ...
            <div class="banner banner-cat">
                ...
                <div class="banner-content banner-content-static text-center">
                    <h3 class="banner-title">Kategori Adı</h3>
                    <h4 class="banner-subtitle">54 Ürün</h4>
                    <a href="#" class="banner-link">Ürünleri İncele</a>
                </div>
            </div>
            <div class="banner banner-cat">
            ...
            <div class="banner banner-cat">
                ...
                <div class="banner-content banner-content-static text-center">
                    <h3 class="banner-title">Kategori Adı</h3>
                    <h4 class="banner-subtitle">37 Ürün</h4>
                    <a href="#" class="banner-link">Ürünleri İncele</a>
                </div>
            </div>
            <div class="banner banner-cat">
                ...
                <div class="banner-content banner-content-static text-center">
                    <h3 class="banner-title">Kategori Adı</h3>
                    <h4 class="banner-subtitle">85 Ürün</h4>
                    <a href="#" class="banner-link">Ürünleri İncele</a>
                </div>
            </div>
            <div class="banner banner-cat">
                ...
                <div class="banner-content banner-content-static text-center">
                    <h3 class="banner-title">Kategori Adı</h3>
                    <h4 class="banner-subtitle">14 Ürün</h4>
                    <a href="#" class="banner-link">Ürünleri İncele</a>
                </div>
            </div>
            <div class="banner banner-cat">
                ...
                <div class="banner-content banner-content-static text-center">
                    <h3 class="banner-title">Kategori Adı</h3>
                    <h4 class="banner-subtitle">42 Ürün</h4>
                    <a href="#" class="banner-link">Ürünleri İncele</a>
                </div>
            </div>
            <div class="banner banner-cat">
                ...
                <div class="banner-content banner-content-static text-center">
                    <h3 class="banner-title">Kategori Adı</h3>
                    <h4 class="banner-subtitle">50 Ürün</h4>
                    <a href="#" class="banner-link">Ürünleri İncele</a>
                </div>
            </div>
            <div class="banner banner-cat">
                ...
                <div class="banner-content banner-content-static text-center">
                    <h3 class="banner-title">Kategori Adı</h3>
                    <h4 class="banner-subtitle">20 Ürün</h4>
                    <a href="#" class="banner-link">Ürünleri İncele</a>
                </div>
            </div>
            <div class="banner banner-cat">
