...
@section('title', $Edit->title.' | Çevirmen Düzenle')
@section('content')
    {{Form::model($Edit, ["route" => ["translator.update", $Edit->id],'enctype' => 'multipart/form-data'])}}
    @method('PUT')
    <div class="row">
...
@section('customJS')
    ...
    <script type="text/javascript">
        ...
        CKEDITOR.replace( 'aciklama', {
            filebrowserUploadUrl: "{{ route('translator.postUpload', ['_token' => csrf_token()]) }}",
