...
@section('title', 'Çevirmen Listele')
@section('content')
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a class="btn btn-primary btn-sm me-1" href="{{ route('translator.create') }}" title="Kampanya Ekle">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        Çevirmen Ekle
                    </a>
                </div>
                ...
                <table class="table table-hover table-striped table-bordered">
                            ...
                            <div class="btn-list flex-nowrap">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item justify-content-between" href="{{ route('translator.edit', $item->id) }}" title="Düzenle">
                        ...
                        <div class="modal-dialog modal-sm" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('translator.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                    ...
                    <div class="row">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="col-12 col-md-9">{{ $All->appends(['siralama' => 'translator'])->links() }}</div>
        ...
        $(document).ready(function() {
            $('#orders').sortable({
                update:function()
                {
                    ...
                    $.get("{{ route('translator.getOrder') }}?"+siralama,() => {
            ...
            $('.switch').change(function() {
                ...
                $.get("{{route('translator.getSwitch')}}", {id:id,status:status},
                    () => {
                        if(status) {}
                    });
            })
